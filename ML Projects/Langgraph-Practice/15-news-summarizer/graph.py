...
from functions.newspresso_team.top_headlines_team.top_headlines_firebase_pusher_agent import top_headlines_firebase_pusher_node
...
workflow.add_node(TOP_HEADLINES_FIREBASE_PUSHER_AGENT, top_headlines_firebase_pusher_node)
