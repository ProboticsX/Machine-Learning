...
def podcast_transcript_generator_node(state: AgentState) -> Command[Literal[PODCAST_SUPERVISOR_AGENT]]:
    ...
    podcast_transcript_generator_agent = create_react_agent(llm, 
                                             ...
                                             prompt = podcast_transcript_generator_prompt,
                                             )
    invoke_message = {"top_headlines_summary": top_headlines_summary}
    print("===INVOKE MESSAGE=====")
    print(invoke_message)
...
#NEWS SUPERVISOR
news_supervisor_members = [TOP_HEADLINES_SUPERVISOR_AGENT, PODCAST_SUPERVISOR_AGENT]
...
# PODCAST SUPERVISOR
podcast_supervisor_members = [PODCAST_TRANSCRIPT_GENERATOR_AGENT]
