...
if __name__ == "__main__":
    print("Hello from Reflection Graph with tools!")
    topic = """"Write about AI-Powered SOC / autonomous soc  problem domain, list startups that do that and raised capital."""
    # displayGraph(graph) 
    
    # response = graph.invoke({"messages":[topic]})
